...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['info@travelrent.com', 'support@travelrent.com']
    },
    {
      icon: MapPin,
      title: 'Address',
      details: ['123 Travel Street', 'Downtown, NY 10001']
    },
    {
      icon: Clock,
      title: 'Hours',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to start your journey? Contact us today for bookings or any questions
          </p>
        </div>
